...
start:
	...
	;Переходим в 3 видеорежим и очищаем экран    
	;mov ax, 3h
	;int 10h
	...
	;inc dh		;переходим на одну строку ниже
	;call SetCursorPos
	
	;mov bp, press		;Вывод на экран строки Con
	;mov cx, 28		;Длина строки
	;call PrintMes
...
StartKernel:
	...
	mov al, 08h	    ;кол-во читаемых секторов -1
	mov ah, 02h
	int 13h
...
;===================== выводимые сообщения===================== 
	;title db 'Mishin870 OS Boot loader v1.0', 0 ;29
	;press db 'Press any key to continue...', 0 ;28
